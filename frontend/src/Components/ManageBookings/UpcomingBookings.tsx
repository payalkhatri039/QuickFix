...
/**
 * @returns the upcoming bookings of student/TA in table format
 */
export default function UpcomingBookings() {
  // Retrieves the upcoming bookings list from redux - store : bookingsReducer
  const upcomingBooking = useSelector(
    (state: RootState) => state.bookings.upcoming
  );
   ...
   */
  useEffect(() => {
    const bookingMap = upcomingBooking.map((eachBooking, counter) => {
